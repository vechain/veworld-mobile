...
describe("LoginBottomSheet", () => {
    ...
    it("should be able to cancel login", async () => {
        const loginBsRef = { current: { present: jest.fn(), close: jest.fn() } }
    ...
    it("should be able to login without signing", async () => {
        const loginBsRef = { current: { present: jest.fn(), close: jest.fn() } }
        const postMessage = jest.fn()
        jest.spyOn(InteractionProvider, "useInteraction").mockReturnValue({
            loginBsRef,
    ...
    it("should be able to login with certificate", async () => {
        const loginBsRef = { current: { present: jest.fn(), close: jest.fn() } }
        const postMessage = jest.fn()
        jest.spyOn(InteractionProvider, "useInteraction").mockReturnValue({
            loginBsRef,
    ...
    it("should be able to login with typed-data", async () => {
        const loginBsRef = { current: { present: jest.fn(), close: jest.fn() } }
        const postMessage = jest.fn()
        jest.spyOn(InteractionProvider, "useInteraction").mockReturnValue({
            loginBsRef,

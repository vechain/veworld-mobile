...
import Animated, { useAnimatedProps, AnimatedProps, SharedValue } from "react-native-reanimated"
...
interface BaseAnimatedTextProps extends Omit<TextInputProps, "value" | "style"> {
    text: SharedValue<string>
    style?: AnimatedProps<RNTextProps>["style"]
}

export const AnimatedTextInput = Animated.createAnimatedComponent(TextInput)
export const BaseAnimatedText = (props: BaseAnimatedTextProps): React.ReactNode => {

...
export const BaseButtonGroupHorizontal = ({
    ...
    const calculateBGColor = useCallback(
        ...
        [customStyles, theme.colors.card, theme.colors.disabled, theme.colors.horizontalButtonSelected],
    )
    ...
    const calculateTextColor = useCallback(
        ...
        [customStyles, theme.colors.textSecondary, theme.colors.horizontalButtonTextReversed, theme.colors.text],
    )

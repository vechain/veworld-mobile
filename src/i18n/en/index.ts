...
const en: BaseTranslation = {
    ...
    BD_BACKUP_RECOVERY_PHRASE: "The recovery phrases backup ensure you never lose access to your wallet in case of app reset or lost device.",
    ...
    SB_BACKUP_RECOVERY_PHRASE: "Backup “Recovery phrase”",

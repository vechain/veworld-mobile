...
const en: BaseTranslation = {
    ...
    SEND_ACCEPT_NO_GAS_TITLE: "INSUFFICIENT GAS FEE",
    SEND_ACCEPT_NO_GAS_WARNING: "I UNDERSTAND",
    SEND_ACCEPT_NO_GAS_MESSAGE: "An insufficient gas fee may result in a failed transaction.",

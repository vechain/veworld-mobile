...
export enum AnalyticsEvent {
    ...
    DAPP_UNIVERSAL_LINK_TRANSACTION_SUCCESS = "DAPP_UNIVERSAL_LINK_TRANSACTION_SUCCESS",
    DAPP_UNIVERSAL_LINK_TRANSACTION_FAILURE = "DAPP_UNIVERSAL_LINK_TRANSACTION_FAILURE",

...
export enum AnalyticsEvent {
    ...
    WALLET_ADD_SMART_WALLET_SUCCESS = "WALLET_ADD_SMART_WALLET_SUCCESS",
    WALLET_ADD_SMART_WALLET_ERROR = "WALLET_ADD_SMART_WALLET_ERROR",
    ...
    SELECT_WALLET_IMPORT_CLOUD = "SELECT_WALLET_IMPORT_CLOUD",
    ...
    DISCOVERY_STARGATE_X_VEBETTER_BANNER_CLICKED = "DISCOVERY_STARGATE_X_VEBETTER_BANNER_CLICKED",
    DISCOVERY_STARGATE_X_VEBETTER_BANNER_CLOSED = "DISCOVERY_STARGATE_X_VEBETTER_BANNER_CLOSED",
    ...
    NFT_COLLECTION_FAVORITE_ADDED = "NFT_COLLECTION_FAVORITE_ADDED",
    NFT_COLLECTION_FAVORITE_REMOVED = "NFT_COLLECTION_FAVORITE_REMOVED",
    NFT_FAVORITE_ADDED = "NFT_FAVORITE_ADDED",
    NFT_FAVORITE_REMOVED = "NFT_FAVORITE_REMOVED",
    ...
    DAPP_LOGIN_SUCCESS = "DAPP_LOGIN_SUCCESS",
    DAPP_LOGIN_FAILED = "DAPP_LOGIN_FAILED",
    DAPP_LOGIN_REJECTED = "DAPP_LOGIN_REJECTED",
    DAPP_LOGIN_REQUESTED = "DAPP_LOGIN_REQUESTED",

    /**
     * Balance Screen
     */
    DASHBOARD_RECEIVE_CLICK = "DASHBOARD_RECEIVE_CLICK",
    DASHBOARD_SEND_CLICK = "DASHBOARD_SEND_CLICK",
    DASHBOARD_SWAP_CLICK = "DASHBOARD_SWAP_CLICK",
    DASHBOARD_EARN_CLICK = "DASHBOARD_EARN_CLICK",
    DASHBOARD_BUY_CLICK = "DASHBOARD_BUY_CLICK",
    ...
    NFT_COLLECTIBLE_AVATAR_CHANGED = "NFT_COLLECTIBLE_AVATAR_CHANGED",
    NFT_COLLECTIBLE_AVATAR_DELETED = "NFT_COLLECTIBLE_AVATAR_DELETED",
    COLLECTIBLES_TAB_OPENED = "COLLECTIBLES_TAB_OPENED",
    COLLECTIBLES_SEE_MORE_BUTTON_CLICKED = "COLLECTIBLES_SEE_MORE_BUTTON_CLICKED",
    COLLECTIBLES_COLLECTION_DETAILS_OPENED = "COLLECTIBLES_COLLECTION_DETAILS_OPENED",

    TOKEN_RECEIVE_CLICKED = "TOKEN_RECEIVE_CLICKED",
    TOKEN_CONVERT_CLICKED = "TOKEN_CONVERT_CLICKED",
    TOKEN_SEND_CLICKED = "TOKEN_SEND_CLICKED",
    TOKEN_BUY_CLICKED = "TOKEN_BUY_CLICKED",
    TOKEN_EARN_CLICKED = "TOKEN_EARN_CLICKED",

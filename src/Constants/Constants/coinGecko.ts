...
export const COINGECKO_MARKET_CHART_ENDPOINT = (coin: string) => `${COINGECKO_URL}/coins/${coin}/market_chart`
...
export const COINGECKO_MARKET_INFO_ENDPOINT = (coins: string[], currency: string) =>
    `${COINGECKO_URL}/coins/markets?vs_currency=${currency.toLowerCase()}&ids=${coins[0]}%2C%20${
        coins[1]

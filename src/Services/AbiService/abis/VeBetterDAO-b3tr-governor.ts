export default [
  ...
  {
    "inputs": [],
    "name": "GOVERNOR_FUNCTIONS_SETTINGS_ROLE",
    "outputs": [
      {
        "internalType": "bytes32",
        "name": "",
    ...
    "inputs": [
      {
        "components": [
          ...
          {
            "internalType": "bool",
            "name": "isFunctionRestrictionEnabled",
            "type": "bool"
          }
        ],
        "internalType": "struct GovernorTypes.InitializationData",
        "name": "data",
        "type": "tuple"
      },
      {
        "components": [
          ...
          {
            "internalType": "address",
            "name": "governorFunctionSettingsRoleAddress",
            "type": "address"
          }
        ],
        "internalType": "struct GovernorTypes.InitializationRolesData",
        "name": "rolesData",
        "type": "tuple"
      }
    ],
  ...
  },
  {
    ...
    "name": "setDepositThresholdPercentage",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },
  {
    ...
    "name": "setIsFunctionRestrictionEnabled",
    "outputs": [],
    "stateMutability": "nonpayable",
    "type": "function"
  },

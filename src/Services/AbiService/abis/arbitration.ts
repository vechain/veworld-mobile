export default [
  ...
  },
  {
    "constant": true,
    "inputs": [],
    "name": "DISPUTE_DISPERSAL_DURATION",
    "outputs": [
      {
        "name": "",
        "type": "uint256"

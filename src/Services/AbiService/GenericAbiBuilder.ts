...
const genericAbiBuilder = new AbiBuilder()
...
// .addAbi(prototype)
// .addAbi(stargateDelegation)
// .addAbi(stargateNft)
// .addAbi(thornodeClockauction)
// .addAbi(thornodeTokenauction)
// .addAbi(ticket)
// .addAbi(uniswapV2Factory)
// .addAbi(uniswapV2Pair)
// .addAbi(uniswapV2Router02)
// .addAbi(vales)
// .addAbi(vearnTrader)

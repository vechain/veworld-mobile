...
export const scaleNumberUp = (
    ...
    try {
        ...
        throw veWorldErrors.rpc.internal({
            message: `Failed to scale number up (${val})`,
            error: e,
        })
    }
}
...
export const scaleNumberDown = (
    ...
    try {
        ...
        error(e)
        throw veWorldErrors.rpc.internal({
            message: `Failed to scale number down (${val})`,
            error: e,
        })
    }
}
...
export const humanNumber = (
    ...
    // docs here https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl/NumberFormat/NumberFormat

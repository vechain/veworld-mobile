export enum Routes {
    ...
    ACTIVITY_STAKING = "ACTIVITY_STAKING",
    NFTS = "NFTs",
    NFT_DETAILS = "NFT_Details",
    NFT_COLLECTION_DETAILS = "NFT_Collection_Details",
    REPORT_NFT_TRANSACTION_SCREEN = "Report_NFT_Transaction_Screen",
    SELL_FLOW = "Sell_Flow",
    ...
    DISCOVER_DAPPS_SECTION = "Discover_Dapps_Section",
    DISCOVER_VEBETTER_SECTION = "Discover_VeBetter_Section",

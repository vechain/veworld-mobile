...
export const wcMethodsToRequestTranslations = (methods: string[], LL: TranslationFunctions) => {
    ...
    if (methods.includes(RequestMethods.SIGN_CERTIFICATE)) translations.push(LL.CONNECTION_REQUEST_SIGN_DESCRIPTION())

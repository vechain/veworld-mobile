...
describe("ActivityDetailsUtils", () => {
    describe("getActivityTitle", () => {
        it.each([
            ...
            [ActivityType.B3MO_QUEST_CREATED, "Created B3MO quest"],
            [ActivityType.B3MO_QUEST_JOINED, "Joined B3MO quest"],
            [ActivityType.B3MO_QUEST_REWARD_CLAIMED, "Claimed B3MO quest reward"],
            [ActivityType.B3MO_QUEST_REFUND_CLAIMED, "Claimed B3MO quest refund"],
            [ActivityType.B3MO_QUEST_CREATOR_REFUNDED, "Claimed unused B3MO quest slots"],
            [ActivityType.B3MO_QUEST_LEFT, "Left B3MO quest"],
            [ActivityType.B3MO_QUEST_CANCELLED, "Cancelled B3MO quest"],
            [ActivityType.B3MO_QUEST_DECLINED, "Declined B3MO quest"],
            [ActivityType.B3MO_QUEST_COMPLETED, "Completed B3MO quest"],

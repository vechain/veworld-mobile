...
export const VbdBalanceCard = memo(
    ({ isBalanceVisible, openQRCodeSheet, isObserved, convertB3trBottomSheetRef }: Props) => {
        ...
        const { amount: veB3trFiatBalance } = useMemo(
            () => combineFiatBalances(balances),
            [balances, combineFiatBalances],
        )

...
export const MarketInfoView = ({ marketInfo, tokenSymbol }: { marketInfo: CoinMarketInfo; tokenSymbol: string }) => {
    const { styles } = useThemedStyles(baseStyles)
    const { LL } = useI18nContext()
    const { marketCap, totalSupply, totalVolume, circulatingSupply } = useFormattedMarketInfo(marketInfo, tokenSymbol)

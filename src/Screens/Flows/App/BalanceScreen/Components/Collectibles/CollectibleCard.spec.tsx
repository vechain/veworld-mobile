...
jest.mock("~Hooks/useCollectibleTransferDetails", () => ({
    useCollectibleTransferDetails: jest.fn(),
}))
...
describe("CollectibleCard", () => {
    ...
    it("should render correctly", async () => {
        ;(useCollectibleTransferDetails as jest.Mock).mockReturnValueOnce(mockedTransferDetails)
    ...
    it("should render the collectible even if block timestamp is not available", async () => {
        ;(useCollectibleTransferDetails as jest.Mock).mockReturnValueOnce({
            data: {
                data: {
                    data: [],
                    pagination: {

...
export const useTotalFiatBalance = (tokenTotalBalance: string, exchangeRate: CurrencyExchangeRate | undefined) => {
    /**
    ...
    const fiatTotalBalance = useMemo(
        () => FormattingUtils.convertToFiatBalance(tokenTotalBalance || "0", exchangeRate?.rate ?? 1, 0),

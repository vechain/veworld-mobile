...
export const calculateAmountWithoutGas = ({ gas, selectedFeeOption, clauses, isDelegated, vtho }: Props) => {
    ...
    for (const clause of vthoTransferClauses) {
        ...
        const isEnoughGas = txCostTotal.isLessThanOrEqualTo(totalBalance)
        return isEnoughGas
    }
}

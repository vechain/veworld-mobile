...
type NavigationScreenPropAlias = NativeStackScreenProps<RootStackParamListHome, Routes.SELECT_TOKEN_SEND>

type NavigationType = NativeStackNavigationProp<RootStackParamListHome, Routes.SELECT_TOKEN_SEND, undefined>

type RouteType = RouteProp<RootStackParamListHome, Routes.SELECT_TOKEN_SEND>

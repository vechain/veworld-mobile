...
type NavigationScreenPropAlias = NativeStackScreenProps<RootStackParamListHome, Routes.REPORT_NFT_TRANSACTION_SCREEN>

type NavigationType = NativeStackNavigationProp<RootStackParamListHome, Routes.REPORT_NFT_TRANSACTION_SCREEN, undefined>

type RouteType = RouteProp<RootStackParamListHome, Routes.REPORT_NFT_TRANSACTION_SCREEN>

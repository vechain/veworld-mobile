...
export const HeaderComponent = memo(
    ({ collection, openReportBottomSheet }: { collection: NftCollection; openReportBottomSheet?: boolean }) => {
        ...
        // Auto-open report bottom sheet if requested via navigation params
        useEffect(() => {
        ...
        }, [openReportBottomSheet, onOpenReportCollection])

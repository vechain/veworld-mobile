...
import { useApplicationSecurity, usePersistedCache, usePersistedTheme, useVeChat } from "~Components/Providers"
...
export const useAppReset = () => {
    ...
    const { deleteAllChatsDb } = useVeChat()

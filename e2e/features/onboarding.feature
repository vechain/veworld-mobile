...
Feature: User Onboarding
  ...
  Scenario Outline: User attemps to import a local wallet with an invalid mnemonic or private key
    When The user onboards with an imported mnemonic or private key "<mnemonicOrPk>"
  ...
  Scenario Outline: User attemps to import a local wallet with an invalid pin
    When The user onboards with an imported mnemonic or private key "<mnemonicOrPk>"

...
Feature: User Onboarding
  ...
  Scenario: User successfully creates a local wallet with pin protection
  ...
  Scenario: User attemps to import a local wallet with an invalid mnemonic or private key
    When The user onboards with an imported mnemonic or private key "<mnemonicOrPk>"
  ...
  Scenario: User attemps to import a local wallet with an invalid pin
    When The user onboards with an imported mnemonic or private key "<mnemonicOrPk>"
